/**
 * Server-side data fetcher for Stage 1 progress
 * Uses React cache() for optimal SSR deduplication
 * Direct Prisma queries for fast initial page load
 */
...
export interface Stage1Data {
  ...
  pahmIntro: PahmIntroProgress
  summary: Stage1Summary
  userId: string
}

/**
 * Fetch Stage 1 progress with all sub-stages (T1-T5) and PAHM intro
 * Uses React cache() for optimal performance during SSR
 */
