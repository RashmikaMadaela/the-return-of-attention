...
import type { UserProfileData } from '@/lib/data/user-profile-data'

interface UserProfileClientProps {
  initialData: UserProfileData | null
}

export function UserProfileClient({ initialData }: UserProfileClientProps) {
  ...
  const userProfile = {
    ...
    nationality: initialData.profile?.nationality || '',
    currentCountry: initialData.profile?.country || '',
    happiness: initialData.happiness || 0,
    sessions: initialData.sessions || 0,
    userLevel: initialData.userLevel || 'Seeker',
    hours: initialData.hours || 0
  }

  const assessmentStatus = {
    questionnaire: initialData.questionnaireCompleted || false,
    selfAssessment: initialData.selfAssessmentCompleted || false
  }
