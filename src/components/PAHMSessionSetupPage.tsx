...
import type { StartSessionRequest, ExerciseType } from '@/lib/api/sessions'
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#b9d4ee] to-[#fffafa]">
      ...
      <div className="p-3 pt-20 sm:p-6 sm:pt-24 md:p-8">
        <div className="max-w-6xl mx-auto">
          <h1 className="mb-4 text-2xl font-bold text-center text-[#03478f] sm:text-3xl md:text-4xl sm:mb-6 md:mb-8 invisible">'</h1>
