    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-b from-[#b9d4ee] to-[#fffafa] sm:p-6">
      ...
      <div className="w-full max-w-md p-6 shadow-2xl bg-white rounded-3xl sm:p-10 border border-[#d6e8f8]">
        ...
        <div className="mb-6 text-center sm:mb-8">
          ...
          <h1 className="mb-2 text-2xl font-bold text-[#03478f] sm:text-3xl">Create Account</h1>
        ...
        <div className="flex items-start mt-5 mb-4 text-xs sm:mt-6 sm:mb-5 sm:text-sm">
          <input
            ...
            className="mr-2 sm:mr-3 w-4 h-4 sm:w-5 sm:h-5 mt-0.5 rounded border-gray-300 text-[#6465e0] focus:ring-[#6465e0]"
          />
          <label htmlFor="agreeTerms" className="leading-relaxed text-gray-700 cursor-pointer">
            ...
            <a
              ...
              className="font-medium text-[#6465e0] underline hover:text-[#5658d1]"
            >
              Terms of Service
            </a>
            {' '}&{' '}
